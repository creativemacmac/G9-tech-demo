# Multiple Demos to demonstrate and get used to tech such as React Router v4, Redux, React, Semantic-ui and more

To start this project/demo follow the following steps.

- Git Clone this project
- `yarn && yarn start`   (to install packages and spin up server, or `npm install && npm start` instead)
